              ...
              <div className={"card home_card"}>
                <div className={"card-body "}>
                  ...
                  <div className={"d-flex align-items-center px-5 pt-3"}>
                    ...
                    <div><FeatherIcon className={"home-action-icons ms-4 increased-size"} icon={"bookmark"} /></div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className={"card home_card"}>
                <div className={"card-body p-3"}>
                  ...
                  <div className={"d-flex align-items-center px-5 pt-3"}>
                    ...
                    <div><FeatherIcon className={"home-action-icons ms-3 increased-size"} icon={"smile"} /></div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className={"card home_card"}>
                <div className={"card-body p-3"}>
                  ...
                  <div className={"d-flex align-items-center px-5 pt-3"}>
                    ...
                    <div><FeatherIcon className={"home-action-icons ms-3 increased-size"} icon={"meh"} /></div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className={"card home_card"}>
                <div className={"card-body "}>
                  ...
                  <div className={"d-flex align-items-center px-5 pt-3"}>
                    ...
                    <div><FeatherIcon className={"home-action-icons ms-3 increased-size"} icon={"frown"} /></div>
                  </div>
                </div>
              </div>
            </div>
